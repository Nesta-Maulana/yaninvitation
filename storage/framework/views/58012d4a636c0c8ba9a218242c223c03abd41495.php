...
<html lang="en">
   ...
   <head>
      ...
      <link rel="stylesheet" href="<?php echo e(asset('assets/landing-page/fonts/icomoon/style.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/landing-page/css/bootstrap/bootstrap.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/landing-page/css/jquery-ui.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/landing-page/css/owl.carousel.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/landing-page/css/owl.theme.default.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/landing-page/css/owl.theme.default.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/landing-page/css/jquery.fancybox.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/landing-page/css/bootstrap-datepicker.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/landing-page/fonts/flaticon/font/flaticon.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/landing-page/css/aos.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/landing-page/css/style.css')); ?>">
   ...
   <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      ...
      <div class="site-wrap">
         ...
         <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
            <div class="container">
               <div class="row align-items-center justify-content-center">
                  <div class="col-4">
                     <h1 class="m-0 site-logo"><a href="javascript:void(0)">YANINVITATION</a></h1>
                  </div>
                  <div class="col-8">
         ...
         <div class="site-blocks-cover overlay bg-light" style="background-image: url('<?php echo e(asset('assets/landing-page/images/hero_bg_1.jpg')); ?>'); " id="home-section">
            <div class="container">
               <div class="row justify-content-center">
                  <div class="col-12 text-center align-self-center text-intro">
                     <div class="row justify-content-center">
                        <div class="col-lg-8">
                           <h1 class="text-white" data-aos="fade-up" data-aos-delay="">We Are Digital Invitation Specialist</h1>
                           <p class="lead text-white" data-aos="fade-up" data-aos-delay="100">Create your own digital invitation here. We will provide all special offers and services for your special day. <span style="color:#fff419">Because, the special starts from us.</span></p>
            ...
            <div class="container">
               <div class="row ">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4">
                     <p>We Offer an invitations for your special day so you can always be remembered for all time. We are here as the best solution and ready to become a vendor who will provide special offers and services for your special day.</p>
                     <p>No need to rush, plan a digital invitation for your special day with us. We will prepare to serve with the best offers and services compared to others. Because, the special starts from us.</p>
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-4">
                     <img src="<?php echo e(asset('assets/landing-page/images/yan logo')); ?>.jpg" alt="Image" class="img-fluid">
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-4">
                     <p>Menghadirkan sebuah undangan hari spesialmu agar selalu bisa dikenang sepanjang masa. Kami hadir sebagai solusi terbaik dan siap menjadi vendor yang akan memberikan penawaran dan servis yang spesial untuk hari spesialmu.</p>
                     <p>Tak usah terlalu terburu-buru, rencanakan undangan digital untuk hari spesialmu bersama kami. Kami akan siap sedia melayani dengan penawaran dan pelayan yang paling terbaik diantara yang lain. Sebab, yang spesial berawal dari kami.</p>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="container">
               ...
               <div id="posts" class="row no-gutter">
                  <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
                     <a href="<?php echo e(asset('assets/landing-page/images/img_5.jpg')); ?>" class="item-wrap fancybox">
                     <span class="icon-search2"></span>
                     <img class="img-fluid" src="<?php echo e(asset('assets/landing-page/images/img_5.jpg')); ?>">
                     </a>
                  </div>
                  <div class="item brand col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
                     <a href="<?php echo e(asset('assets/landing-page/images/img_6.jpg')); ?>" class="item-wrap fancybox">
                     <span class="icon-search2"></span>
                     <img class="img-fluid" src="<?php echo e(asset('assets/landing-page/images/img_6.jpg')); ?>">
                     </a>
                  </div>
                  <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
                     <a href="<?php echo e(asset('assets/landing-page/images/img_7.jpg')); ?>" class="item-wrap fancybox">
                     <span class="icon-search2"></span>
                     <img class="img-fluid" src="<?php echo e(asset('assets/landing-page/images/img_7.jpg')); ?>">
                     </a>
                  </div>
                  <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
                     <a href="<?php echo e(asset('assets/landing-page/images/img_1.jpg')); ?>" class="item-wrap fancybox">
                     <span class="icon-search2"></span>
                     <img class="img-fluid" src="<?php echo e(asset('assets/landing-page/images/img_1.jpg')); ?>">
                     </a>
                  </div>
                  <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
                     <a href="<?php echo e(asset('assets/landing-page/images/img_2.jpg')); ?>" class="item-wrap fancybox">
                     <span class="icon-search2"></span>
                     <img class="img-fluid" src="<?php echo e(asset('assets/landing-page/images/img_2.jpg')); ?>">
                     </a>
                  </div>
                  <div class="item brand col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
                     <a href="<?php echo e(asset('assets/landing-page/images/img_3.jpg')); ?>" class="item-wrap fancybox">
                     <span class="icon-search2"></span>
                     <img class="img-fluid" src="<?php echo e(asset('assets/landing-page/images/img_3.jpg')); ?>">
                     </a>
                  </div>
                  <div class="item design col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
                     <a href="<?php echo e(asset('assets/landing-page/images/img_4.jpg')); ?>" class="item-wrap fancybox">
                     <span class="icon-search2"></span>
                     <img class="img-fluid" src="<?php echo e(asset('assets/landing-page/images/img_4.jpg')); ?>">
                     </a>
                  </div>
                  <div class="item design col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
                     <a href="<?php echo e(asset('assets/landing-page/images/img_8.jpg')); ?>" class="item-wrap fancybox">
                     <span class="icon-search2"></span>
                     <img class="img-fluid" src="<?php echo e(asset('assets/landing-page/images/img_8.jpg')); ?>">
                     </a>
                  </div>
                  <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
                     <a href="<?php echo e(asset('assets/landing-page/images/img_9.jpg')); ?>" class="item-wrap fancybox">
                     <span class="icon-search2"></span>
                     <img class="img-fluid" src="<?php echo e(asset('assets/landing-page/images/img_9.jpg')); ?>">
                     </a>
                  </div>
                  <div class="item design col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
                     <a href="<?php echo e(asset('assets/landing-page/images/img_10.jpg')); ?>" class="item-wrap fancybox">
                     <span class="icon-search2"></span>
                     <img class="img-fluid" src="<?php echo e(asset('assets/landing-page/images/img_10.jpg')); ?>">
                     </a>
                  </div>
                  <div class="item brand col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
                     <a href="<?php echo e(asset('assets/landing-page/images/img_11.jpg')); ?>" class="item-wrap fancybox">
                     <span class="icon-search2"></span>
                     <img class="img-fluid" src="<?php echo e(asset('assets/landing-page/images/img_11.jpg')); ?>">
                     </a>
                  </div>
               </div>
            </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6 mb-5 mb-lg-0 col-lg-4">
                     <div class="blog_entry">
                        <a href="single.html"><img src="<?php echo e(asset('assets/landing-page/images/blog_1.jpg')); ?>" alt="Image" class="img-fluid"></a>
                  ...
                  <div class="col-md-6 mb-5 mb-lg-0 col-lg-4">
                     <div class="blog_entry">
                        <a href="single.html"><img src="<?php echo e(asset('assets/landing-page/images/blog_2.jpg')); ?>" alt="Image" class="img-fluid"></a>
                        <div class="p-4 bg-white">
                           <h3><a href="single.html">A small river named Duden flows by their place</a></h3>
                           <span class="date">April 25, 2019</span>
                           <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                  ...
                  <div class="col-md-6 mb-5 mb-lg-0 col-lg-4">
                     <div class="blog_entry">
                        <a href="single.html"><img src="<?php echo e(asset('assets/landing-page/images/blog_3.jpg')); ?>" alt="Image" class="img-fluid"></a>
                        <div class="p-4 bg-white">
                           <h3><a href="single.html">A small river named Duden flows by their place</a></h3>
                           <span class="date">April 25, 2019</span>
                           <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
      ...
      <script src="<?php echo e(asset('assets/landing-page/js/jquery-3.3.1.min.js')); ?> " type="f251375959fed7fed32f1144-text/javascript"></script>
      <script src="<?php echo e(asset('assets/landing-page/js/jquery-ui.js')); ?> " type="f251375959fed7fed32f1144-text/javascript"></script>
      <script src="<?php echo e(asset('assets/landing-page/js/popper.min.js')); ?> " type="f251375959fed7fed32f1144-text/javascript"></script>
      <script src="<?php echo e(asset('assets/landing-page/js/bootstrap.min.js')); ?> " type="f251375959fed7fed32f1144-text/javascript"></script>
      <script src="<?php echo e(asset('assets/landing-page/js/owl.carousel.min.js')); ?> " type="f251375959fed7fed32f1144-text/javascript"></script>
      <script src="<?php echo e(asset('assets/landing-page/js/jquery.easing.1.3.js')); ?> " type="f251375959fed7fed32f1144-text/javascript"></script>
      <script src="<?php echo e(asset('assets/landing-page/js/aos.js')); ?> " type="f251375959fed7fed32f1144-text/javascript"></script>
      <script src="<?php echo e(asset('assets/landing-page/js/jquery.fancybox.min.js')); ?> " type="f251375959fed7fed32f1144-text/javascript"></script>
      <script src="<?php echo e(asset('assets/landing-page/js/jquery.sticky.js')); ?> " type="f251375959fed7fed32f1144-text/javascript"></script>
      <script src="<?php echo e(asset('assets/landing-page/js/isotope.pkgd.min.js')); ?> " type="f251375959fed7fed32f1144-text/javascript"></script>
      <script src="<?php echo e(asset('assets/landing-page/js/main.js')); ?>" type="f251375959fed7fed32f1144-text/javascript"></script>
      <script async src="https://www.googletagmanager.com/gtag/js?id=UA-23581568-13" type="f251375959fed7fed32f1144-text/javascript"></script>
      <script type="f251375959fed7fed32f1144-text/javascript">
      ...
      <script src="<?php echo e(asset('assets/landing-page/ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js')); ?>" data-cf-settings="f251375959fed7fed32f1144-|49" defer=""></script>
   </body>
   <!-- Mirrored from colorlib.com/preview/theme/services/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2020 08:16:22 GMT -->
</html><?php /**PATH C:\xampp\htdocs\yaninvitation\resources\views/yaninvitation/index.blade.php ENDPATH**/ ?>